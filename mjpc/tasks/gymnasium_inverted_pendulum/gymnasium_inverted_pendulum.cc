...
namespace mjpc {
std::string GymnasiumInvertedPendulum::XmlPath() const {
  return GetModelPath("gymnasium_inverted_pendulum/task.xml");
}
std::string GymnasiumInvertedPendulum::Name() const { return "GymnasiumInvertedPendulum"; }
...
// ------------------------------------------
void GymnasiumInvertedPendulum::ResidualFn::Residual(const mjModel* model, const mjData* data,
